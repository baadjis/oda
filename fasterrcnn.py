...
def object_detection(img_path, threshold=0.5, rect_th=2, text_size=2, text_th=2):
    ...
    """
    try:
        os.remove("'static/uploads/predicted.jpg'")
    except:
        pass

    print(img)

    cv2.imwrite('static/uploads/predicted.jpg', img)
    return count_classes


if __name__ == '__main__':
    object_detection('static/uploads/traffic.jpg', rect_th=2, text_th=1, text_size=1)
